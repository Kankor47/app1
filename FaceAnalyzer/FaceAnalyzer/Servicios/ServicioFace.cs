        ...
        public static async Task<Face> DetectarRostro(MediaFile foto)
        {
            ...
            try
            {
                if (foto != null)
                {
                    ...
                    var atributosFace = new FaceAttributeType[] { FaceAttributeType.Age, FaceAttributeType.Gender, FaceAttributeType.HeadPose, FaceAttributeType.Emotion, FaceAttributeType.Smile };
